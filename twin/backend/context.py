from resources import summary, facts, style, cv
...
Here is the content of my CV  {name} and it contains all important details/ my work history, project, skills about me:
{cv}
